...
//     <Row style={{ justifyContent:'center', alignItems: 'center', marginTop:5}}>
...
//       buttons={['Personal Details', 'Other Detail']}
...
//         <Label style={{color:'#ffffff', fontSize:25 }}> <Icon name='person' style={{color:'#ffffff' , fontSize:25}}/>     First Name</Label>
...
//         {/* <Label style={{color:'#ffffff' ,  fontSize:10}}>  */}
//         {/* <Icon name='person' style={{color:'#ffffff' , fontSize:25}}/>   Last Name</Label> */}
//         {/* <Input style={{color:'#ffffff' , height: 70, borderLeftWidth: 4, borderBottomWidth:4, borderTopWidth:4 , borderColor:"white",
//        borderRightWidth: 4,  }} value={lname} onChangeText={val => setUser({...user, lname:val})}/> */}
//     <Icon style={styles.searchIcon} name="ios-search" size={20} color="#000"/>
//  {/* <Icon  name="ios-search"   color="#000"/> */}
// <TextInput
//     label='Email'
//    value={fname} onChangeText={val => setUser({...user, fname:val})}
//    style={{backgroundColor:"transparent" , borderTopWidth:4,borderStyle:"solid", borderColor:"white" , margin:10 ,  borderLeftWidth: 4,
//    borderRightWidth: 4, width:350 , height:50, borderBottomWidth:4 }}
//   />
//         {/* </Item> */}
//     </Row>
...
//     <Item style={[{ width:'100%'}, error === 'dob' ? {borderColor:'red'} : {borderColor:'#ffffff'} ]}>
//         <DatePicker
//         style={{width: '100%'}}
//         date={dob}
//         keyboardType="date"
...
//         <Label style={{color:'#ffffff'}}>   <Icon name='unlock' style={{color:'#ffffff'}}/>Mobile Number</Label>
...
//       {buttonAction === false ?
//     <Button  style={{width:'50%', justifyContent:'center', alignItems:'center', borderColor:'#ffffff'}} onPress={Register} disabled={buttonAction}>
...
//         <View>
//           <Text>There IS NO Record Found </Text>
//         </View>
